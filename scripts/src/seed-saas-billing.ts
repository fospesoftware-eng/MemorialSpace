...
const PLANS = [
  {
    name: "Starter",
    slug: "starter",
    description: "Single small cemetery, up to 500 plots and 3 users.",
    priceCents: 4900,
    trialDays: 14,
    maxUsers: 3,
    maxPlots: 500,
    maxStorageMb: 2_000,
    features: { website: true, accounting: false, ai_map: false, qr: true, columbarium: false },
    isFeatured: false,
    displayOrder: 1,
  },
  {
    name: "Professional",
    slug: "professional",
    description: "Growing cemeteries — full module suite up to 5,000 plots and 15 users.",
    priceCents: 14900,
    trialDays: 14,
    maxUsers: 15,
    maxPlots: 5_000,
    maxStorageMb: 20_000,
    features: { website: true, accounting: true, ai_map: true, qr: true, columbarium: true },
    isFeatured: true,
    displayOrder: 2,
  },
  {
    name: "Enterprise",
    slug: "enterprise",
    description: "Multi-cemetery groups and municipalities. Unlimited everything + priority support.",
    priceCents: 49900,
    trialDays: 30,
    maxUsers: null,
    maxPlots: null,
